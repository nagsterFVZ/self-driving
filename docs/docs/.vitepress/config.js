    ...
    sidebar: {
      "/project/": [
        ...
        },
        {
          text: "Research",
          items: [
            { text: "3D Printing", link: "/project/research/3d-printing" },
            {
              text: "Chassis & Suspension",
              link: "/project/research/chassis-suspension",
            },
            { text: "Control System", link: "/project/research/control" },
            { text: "Differential", link: "/project/research/differential" },
            {
              text: "Power Delivery",
              link: "/project/research/power-delivery",
            },
            { text: "Sensors", link: "/project/research/sensors" },
            {
              text: "Steering & Drivetrain",
              link: "/project/research/steering-drivetrain",
            },
          ],
        },
        {
          text: "Control System",
          items: [{ text: "Installation", link: "/project/installation" }],
        },
      ],
      "/files/": [],
      "/blogs/": [
